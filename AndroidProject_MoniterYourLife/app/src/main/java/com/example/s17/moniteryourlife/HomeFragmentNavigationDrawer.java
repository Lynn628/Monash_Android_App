...
public class HomeFragmentNavigationDrawer extends DrawerLayout {
    private ActionBarDrawerToggle drawerToggle;
    private ListView lvDrawer;
    private ArrayAdapter<String> drawerAdapter;
    private ArrayList<FragmentNavItem> drawerNavItems;
    private int drawerContainerRes;
    public HomeFragmentNavigationDrawer(Context context, AttributeSet attrs, int
            defStyle) {
        super(context, attrs, defStyle);
    }
    public HomeFragmentNavigationDrawer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public HomeFragmentNavigationDrawer(Context context) {
        super(context);
    }
...
// Setup navigation items array
        drawerNavItems = new ArrayList<HomeFragmentNavigationDrawer.FragmentNavItem>();
...
// between the sliding drawer and the action bar icon
    ...
    // Add Drawer items
    public void addNavItem(String navTitle, String windowTitle, Class<? extends
...
// Highlight the selected item, update the title, and close the drawer
    ...
    public Class<? extends Fragment> getDrawerFragment(int position){
        FragmentNavItem navItem = drawerNavItems.get(position);
       return navItem.getFragmentClass();
//        Fragment fragment = null;
//        try {
//            fragment = navItem.getFragmentClass().newInstance();
//            Bundle args = navItem.getFragmentArgs();
